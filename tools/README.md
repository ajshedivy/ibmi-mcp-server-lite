...
`${DB2i_PORT}` (defaults to Mapepire `8076` when unset). TLS verification is on
by default; see [docs/running-on-ibmi.md](../docs/running-on-ibmi.md#tls-certificate-verification).
